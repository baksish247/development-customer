...
function OrderSuccess({orderDetails,onClose}) {
  ...
  return (
    ...
    {orderDetails && <div className="w-full -mb-3 flex bg-[#f3efefaf] shadow-lg shadow-[#c4b48b] flex-col rounded-2xl justify-center items-center">
      ...
      <div className=" w-full mx-auto bg-[#f3efefaf] shadow-lg rounded-lg pb-3 px-4 ">
        <div className="mb-4">
