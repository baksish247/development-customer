    ...
    <div className={`fixed inset-0 flex items-center justify-center z-50 ${isOpen ? 'block' : 'hidden'}`}>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 relative z-10 lg:w-1/3 w-full mx-4">
        ...
        <div className="flex justify-end space-x-4">
          <button
            onClick={onClose}
            className="px-4 py-2 border-2 border-indigo-600 text-gray-800 rounded "
          >
            No, Cancel
          </button>
          <button
            ...
            className="px-4 py-2 bg-indigo-600 disabled:scale-95 diabled:bg-[#7c3155] text-white rounded "
          >
            Yes, Generate
          </button>
        </div>
