    ...
    <div className="min-h-screen max-w-screen bg-white ">
      {isProcessingPayment && (
        <div className="fixed inset-0 flex flex-col z-50 items-center justify-center bg-black/30 backdrop-blur-lg">
          <PaymentLoader />
          <span className="text-zinc-800 mt-2">
            Verifying your payment <br /> Do not close the window
          </span>
        </div>
      )}
      <div className="bg-white h-24 text-indigo-600 p-4">
        {/* <Image
          src={vector}
          alt=""
      ...
      <div className="flex  text-stone-800 justify-center mb-4 mx-4 space-x-2">
        <textarea
          onChange={(e) => {
          ...
          className="px-2 pl-4 text-sm py-1 rounded-lg h-[3.8rem] w-10/12 border-2 border-indigo-600 mr-2"
        />
      </div>
      <div className="text-stone-800 mx-3 flex mb-4 justify-between rounded-lg py-4 px-2 drop-shadow-md shadow-md  mt-2">
        <div>
        ...
        <div className="flex justify-center">
          <span className="relative">
            <input
              ...
              placeholder="100"
              className="px-2 pl-4 rounded-lg  h-14 w-20 border-2 border-indigo-600 mr-2"
            />
